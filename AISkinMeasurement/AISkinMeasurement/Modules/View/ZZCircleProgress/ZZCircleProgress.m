...
- (UIImageView *)pointImage {
    if (!_pointImage) {
        ...
        _pointImage.image = [UIImage imageNamed:@"circle_point3" inBundle:resourcesBundle compatibleWithTraitCollection:nil];
    }
    return _pointImage;
}
...
- (void)layoutSubviews {
    ...
    self.pointImage.frame = CGRectMake(0, 0, _strokeWidth*2, _strokeWidth*2);
    [self updatePointPosition];
