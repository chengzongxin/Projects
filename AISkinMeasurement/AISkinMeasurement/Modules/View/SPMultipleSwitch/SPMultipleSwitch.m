...
static float const cornerRadius = 4;
...
- (void)initialWithItems:(NSArray *)items{
...
- (void)layoutSubviews {
    ...
    self.labelContentView.layer.cornerRadius = cornerRadius;
    self.selectedLabelContentView.layer.cornerRadius = cornerRadius;
    ...
    self.maskTracker.layer.cornerRadius = cornerRadius;
}
