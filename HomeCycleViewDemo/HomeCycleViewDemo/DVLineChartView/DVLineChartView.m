...
@interface DVLineChartView () <DVXAxisViewDelegate,UIScrollViewDelegate>
...
- (void)draw {
    ...
    // 设置 x 轴点 label 颜色
    self.xAxisView.pointTopLabelColor = self.pointTopLabelColor;
    ...
    self.xAxisView.width = self.xAxisTitleArray.count * self.pointGap + 10;
