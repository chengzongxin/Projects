...
open class CandleStickChartRenderer: LineScatterCandleRadarRenderer
{
    ...
    fileprivate func calculateTextPosition(_ valueText: String, originPoint: inout CGPoint, lowestVisibleX: CGFloat, highestVisibleX: CGFloat, isMaxValue: Bool){
        let attributes: [NSAttributedStringKey : Any] = [NSAttributedStringKey.font: UIFont.init(name: "Helvetica", size: 12) ?? UIColor.black, NSAttributedStringKey.foregroundColor: UIColor(red: 51/255.0, green: 51/255.0, blue: 51/255.0, alpha: 1.0)]
