                    ...
                    if(lastRow >= 0) {
                        if(tableView.visibleCells.count > 0) {
                            ...
                            if(indexPath.section == lastSection && indexPath.row == lastRow) {
                                self.frame = CGRectMake(0, CGRectGetMaxY(tableView.visibleCells.lastObject.frame), SCREEN_WIDTH, self->_originalFrame.size.height);
                            }
                        }
                    }
                }
                    ...
                    if(lastRow >= 0) {
                        if(collectionView.indexPathsForVisibleItems.count > 0) {
                            ...
                            if(indexPath.section == lastSection && indexPath.row == lastRow) {
                                ...
                                self.frame = CGRectMake(0, CGRectGetMaxY(cell.frame), SCREEN_WIDTH, self->_originalFrame.size.height);
                            }
                        }
                    }
                }
...
- (void)updateFrame {
    if([self.superView isKindOfClass:[UITableView class]]) {
        ...
        self.frame = CGRectMake(0, y, SCREEN_WIDTH, _originalFrame.size.height);
    }
