                    ...
                    if(lastRow >= 0) {
                        if(tableView.visibleCells.count > 0) {
                            ...
                            if(indexPath.section == lastSection && indexPath.row == lastRow) {
                                self.frame = CGRectMake(0, CGRectGetMaxY(tableView.visibleCells.lastObject.frame), SCREEN_WIDTH, _originalFrame.size.height);
                            }
                        }
                    }
                }
                    ...
                    if(lastRow >= 0) {
                        if(collectionView.indexPathsForVisibleItems.count > 0) {
                            ...
                            if(indexPath.section == lastSection && indexPath.row == lastRow) {
                                ...
                                self.frame = CGRectMake(0, CGRectGetMaxY(cell.frame), SCREEN_WIDTH, _originalFrame.size.height);
                            }
                        }
                    }
                }
